...
class SystemPrompt:
    def __init__(self , char_profile = CHARACTER_PROFILE):
        self.profile = char_profile
        pass
        ...
        system_prompt = f"""
            ...
            * audio
            ...
            - **Potential Tweet Themes:**
              ...
              - Asking questions to the community to interact more.
            ...
            - **Tweet Elements:**
              - Text: 10 to 50 words, thoughtfully crafted to match Josh's character and context.
